...
ADMIN_ROLE_ID = 1521981149671456858 # ⚠️ آيدي رتبة الإدارة (الدعم الفني)
LOG_CHANNEL_ID = 1522756375283892245 # ⚠️ آيدي روم السجلات (اللوق) اللي بتروح له التذاكر بعد الحذف
CATEGORY_ID = 1522757519313731694    # ⚠️ آيدي الكاتيجوري (القسم) اللي بتنفتح داخله التذاكر
# ======================================================
